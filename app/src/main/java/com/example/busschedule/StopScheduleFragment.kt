...
class StopScheduleFragment: Fragment() {
    ...
    // Do the same in StopScheduleFragment. First, get a reference to the view model.
    ...
    // Then configure the recycler view in onViewCreated(). This time you just need to pass in an empty
    // block (function) with {}. You don't actually want anything to happen when rows on this screen are tapped.
